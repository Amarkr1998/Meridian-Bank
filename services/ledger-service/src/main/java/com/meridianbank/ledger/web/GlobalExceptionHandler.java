...
import com.meridianbank.ledger.security.CorrelationIdFilter;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleLedgerException(LedgerException ex, HttpServletRequest request) {
