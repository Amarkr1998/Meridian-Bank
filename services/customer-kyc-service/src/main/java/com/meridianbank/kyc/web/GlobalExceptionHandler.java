...
import com.meridianbank.kyc.security.CorrelationIdFilter;
import com.meridianbank.kyc.web.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleKycException(KycException ex, HttpServletRequest request) {
     ...
     * from {@code @PreAuthorize}, a subtype of this) and explicit resource-ownership checks that
     * throw AccessDeniedException from service code.
     */
