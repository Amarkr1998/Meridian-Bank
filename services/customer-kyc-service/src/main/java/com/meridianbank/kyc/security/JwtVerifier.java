...
import com.meridianbank.kyc.config.JwtVerificationProperties;
...
/**
 * Verifies access tokens issued by auth-service. This service never issues tokens itself — see
 * auth-service's JwtService for the issuing side, and docs/security/security-architecture.md for
 * why every service verifies independently rather than trusting the gateway alone.
 */
@Component
