package com.meridianbank.audit.security;
 ...
 * no outbound synchronous calls and never issues tokens itself; it only guards its read-only
 * audit-query API (ingestion happens exclusively via the Kafka consumer, never HTTP).
 */
@Component
