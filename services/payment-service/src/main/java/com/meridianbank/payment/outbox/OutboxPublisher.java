 ...
 * `audit` package) — but this service's own domain events (`payment.initiated`,
 * `payment.completed`, `payment.failed`) still have no consumer; `notification-service` remains a
 * future phase.
 *
