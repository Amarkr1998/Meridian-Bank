 ...
 * no outbound synchronous calls and never issues tokens itself; it only guards its notification
 * inbox API (ingestion happens exclusively via the Kafka consumer, never HTTP — see
